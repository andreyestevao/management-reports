...
| Arquivo | Descrição |
|---------|-----------|
| `heatmap-atividade-cei-dinamico.html` | Heatmap atividade dinâmico via `/api/heatmap-atividade` |

URL local: http://127.0.0.1:8766/heatmap-atividade-cei-dinamico.html
