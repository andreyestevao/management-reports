...
| Arquivo | Descrição |
|---------|-----------|
| `comparativo-iterations-cei-dinamico.html` | Comparativo iterations dinâmico via `/api/comparativo-iterations` |

URL local: http://127.0.0.1:8766/comparativo-iterations-cei-dinamico.html
